...
// ---- 구글 트렌드 (실시간 급상승 검색어) ----
export async function collectGoogleTrends(geo = "KR") {
...
async function collectNewsByLocale(hl, gl, ceid, source, perTopic = 2) {
  const out = [];
...
export function collectGoogleNewsKR(perTopic = 2) {
  return collectNewsByLocale("ko", "KR", "KR:ko", "google-news", perTopic);
}

export function collectGoogleNewsWorld(perTopic = 1) {
