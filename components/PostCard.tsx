  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-3.5">
        <span className="text-[11px] font-bold text-oddsbag-gray">
          {post.category}
          {post.readMinutes ? ` · ${post.readMinutes}분` : ""}
        </span>
        <h3
          className="mt-1 line-clamp-2 text-sm font-bold leading-snug text-oddsbag-dark group-hover:text-oddsbag-purple"
