...
export const showcase: Showcase[] = [
  ...
  },
  {
    ...
    name: "메모냅 아카이브",
    emoji: "🎬",
    // ★홍보 시작 전이다. 「하고 있다」가 아니라 「준비하고 있다」로만 쓴다.
    //  회사 폴더에 쓸 수 있는 사진이 한 장도 없어서(장비·셋팅 스냅은 공개 금지 소재)
    //  일부러 사진 없이 색과 글자로만 세웠다.
    badge: "준비 중",
    kicker: "MEMONAP ARCHIVE",
    headline: "한 번뿐인 순간을 기록합니다",
    blurb:
      "클래식 공연·학회·심포지엄·기념 행사를 영상과 사진으로 기록하고 중계하는 아카이브 스튜디오입니다. 지금은 문을 여는 준비를 하고 있습니다.",
    cta: {
      label: "홈페이지 보기",
